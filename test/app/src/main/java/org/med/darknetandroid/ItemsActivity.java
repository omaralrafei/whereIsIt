...
//        adapter.setCustomClickListener(new MyAdapter.customClickListener() {
//            @Override
//            public void changeFragment(int itemPosition, int item) {
//                getActivity().setContentView(R.layout.activity_welcome);
//                int SPLASH_TIME = 3000;
//                new Handler().postDelayed(new Runnable() {
//                    @Override
//                    public void run() {
//                        Intent welcome = new Intent(getActivity(), CameraActivity.class);
